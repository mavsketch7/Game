...
export function genItem(f, forceRar, forceSlot) {
        ...
        return {
          ...
          // siempre que el slot sea "casco", y cada clase con más de un
          // diseño real decide qué hacer con el número (ver
          // cascoArqueroTin() en render/character.js); el resto lo ignora.
          ...(slot === "casco" ? { cascoVariante: ri(0, CASCO_VARIANTES_MAX - 1) } : {}),
        };
      }
